...
import 'schema/productoselecionado_record.dart';
import 'schema/carrito_record.dart';
import 'schema/orden_record.dart';
import 'schema/tarjeta_record.dart';
...
export 'schema/productoselecionado_record.dart';
export 'schema/carrito_record.dart';
export 'schema/orden_record.dart';
export 'schema/tarjeta_record.dart';
...
/// Functions to query ProductoselecionadoRecords (as a Stream and as a Future).
Future<int> queryProductoselecionadoRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
...
Stream<List<ProductoselecionadoRecord>> queryProductoselecionadoRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      ProductoselecionadoRecord.collection,
      ProductoselecionadoRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<ProductoselecionadoRecord>> queryProductoselecionadoRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query TarjetaRecords (as a Stream and as a Future).
Future<int> queryTarjetaRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      TarjetaRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<TarjetaRecord>> queryTarjetaRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      TarjetaRecord.collection,
      TarjetaRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<TarjetaRecord>> queryTarjetaRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
